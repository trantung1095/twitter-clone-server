  ...
  emailEmailConfirmationInstructions(email, name, token) {
    ...
    let mailOptions = {
      ...
      html:
        '<b>Hi </b>' +
        name +
        '<br>Please click the link below to confirm your email address<br><br><button><a href="' +
        config.get('frontend_urls.email_confirmation_base_url') +
        '/' +
        token +
  ...
  emailPasswordResetInstructions(email, name, token) {
    ...
    let mailOptions = {
      ...
      html:
        '<b>Hi </b>' +
        name +
        '<br>Please click the link below to reset your password<br><br><button><a href="' +
        config.get('frontend_urls.password_reset_base_url') +
        '/' +
        token +
